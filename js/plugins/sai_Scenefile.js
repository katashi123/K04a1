...
//----------------------------------------------------------------------------------
    ...
    Scene_File.prototype.create = function() {
		...
		//ステータスウインドウの配置
        this._statusWindow = new Window_SavefileStatus(Graphics.boxWidth/2+10, 140, 300, 340);
		...
		//ヘルプウインドウの配置
		this._helpWindow.x = Graphics.boxWidth/2+3;
...
//現状[ファイル名+ID、プレイ時間、地名、持ち金]、名称変更は''の中の文字で
    Window_SavefileStatus.prototype.drawFileId = function(id, x, y) {
		...
		this.drawText('PlayTime：' + ' ', 2, 200, 80);
		this.drawText('Location：' + ' ', 2, 170, 80);
		this.drawText('Gold：' + ' ', 2, 140, 80);
    };
